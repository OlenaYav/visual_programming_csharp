namespace lab1_yavorska_version_2_reload
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			// button2
			// 
			this.button2.Location = new System.Drawing.Point(158, 170);
			...
			// textBox4
			// 
			this.textBox4.Location = new System.Drawing.Point(129, 27);
			...
			// textBox5
			// 
			this.textBox5.Location = new System.Drawing.Point(305, 51);
			...
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(58, 273);
			...
			this.radioButton1.Location = new System.Drawing.Point(0, 217);
			this.radioButton1.Name = "radioButton1";
			this.radioButton1.Size = new System.Drawing.Size(140, 17);
			this.radioButton1.TabIndex = 9;
			this.radioButton1.TabStop = true;
			this.radioButton1.Text = "RESTANGLE/SQUARE";
			...
			this.radioButton2.Location = new System.Drawing.Point(155, 217);
			this.radioButton2.Name = "radioButton2";
			this.radioButton2.Size = new System.Drawing.Size(119, 17);
			this.radioButton2.TabIndex = 10;
			this.radioButton2.TabStop = true;
			this.radioButton2.Text = "PARALLELOGRAM";
			...
			this.radioButton3.Location = new System.Drawing.Point(-3, 250);
			this.radioButton3.Name = "radioButton3";
			this.radioButton3.Size = new System.Drawing.Size(65, 17);
			this.radioButton3.TabIndex = 11;
			this.radioButton3.TabStop = true;
			this.radioButton3.Text = "RHOMB";
			...
			this.radioButton4.Location = new System.Drawing.Point(155, 250);
			...
			this.textBox6.Location = new System.Drawing.Point(263, 118);
			this.textBox6.Multiline = true;
			this.textBox6.Name = "textBox6";
			this.textBox6.Size = new System.Drawing.Size(142, 46);
			...
			this.label1.Text = "бічна сторона";
			// 
			// label2
			// 
			...
			this.label2.Text = "інша бічна сторона";
			// 
			// label3
			// 
			...
			this.label3.Text = "верхня основа";
			// 
			// label4
			// 
			...
			this.label5.Text = "HEIGHT(TO THE SIDE)";
			// 
			// label6
			// 
			...
			// saveXML
			// 
			this.saveXML.Location = new System.Drawing.Point(311, 192);
			this.saveXML.Name = "saveXML";
			this.saveXML.Size = new System.Drawing.Size(94, 31);
			this.saveXML.TabIndex = 20;
			...
			// readXML
			// 
			this.readXML.Location = new System.Drawing.Point(311, 273);
			this.readXML.Name = "readXML";
			this.readXML.Size = new System.Drawing.Size(94, 46);
			this.readXML.TabIndex = 21;
			this.readXML.Text = "read XML from file";
